...
def main(text, file, output_path, language, speaker, speed, device):
    if file:
        if not os.path.exists(text):
            raise FileNotFoundError('Trying to load text from file due to --file/-f flag, but file not found. Remove the --file/-f flag to pass a string.')
